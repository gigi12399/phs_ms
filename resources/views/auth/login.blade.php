...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset("school/assets/vendor/css/pages/page-auth.css")}}" />
    <!-- Helpers -->
        ...
        <div class="card-body">
          ...
          <div class="app-brand justify-content-center">
            <a href="index.html" class="app-brand-link gap-2">
              ...
              <span class="app-brand-text demo text-body fw-bolder logo-text">Genius</span>
            </a>
          </div>
          <!-- /Logo -->
          <h4 class="mb-2">Welcome to Genius! 👋</h4>
