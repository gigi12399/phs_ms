                    ...
                    <div class="card-body">
                      <form action="{{route('period.update', $period->id)}}" method="POST">
                        ...
                        <div class="mb-3">
                          ...
                          <input name="start_time" type="time" class="form-control" id="name" value="{{ $period->start_time }}" />
                          @error('start_time')
                      ...
                      @enderror
                        ...
                        <div class="mb-3">
                          ...
                          <input name="end_time" type="time" class="form-control" id="name" value="{{ $period->end_time }}" />
                          @error('end_time')
                          <div class="text-danger small">{{ $message }}</div>
                      @enderror
                        </div>
