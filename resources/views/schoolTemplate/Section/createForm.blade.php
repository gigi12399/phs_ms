                    ...
                    <div class="card-body">
                      <form action="{{route('section.store')}}" method="POST">
                        ...
                        <div class="mb-3">
                          ...
                          <input name="name" type="text" class="form-control" id="name" value="{{ old('name') }}" placeholder="Enter section..." />
                          @error('name')
                        ...
                        <div class="mb-3">
                          ...
                          <input name="description" type="text" class="form-control" id="name" value="{{ old('description') }}" placeholder="Enter description..." />
                          @error('description')
                          <div class="text-danger small">{{ $message }}</div>
                          @enderror
                        </div>
